  ...
  commands: [
    ...
    },
    {
      ...
      response: [
        ...
        [2, ['batteryData', 'averageCellVoltage'], ['Int16', 'littleEndian', 0.001, 3]],
        [2, ['batteryData', 'cellVoltageDelta'], ['Int16', 'littleEndian', 0.001, 3]],
        [2, ['batteryData', 'balanceCurrent'], ['Int16', 'littleEndian', 0.001, 3]],
        ...Array.from(Array(24)).map<PackedItemDescription>(() => [
          2,
        ...
        [4, ['batteryData', 'voltage'], ['Uint32', 'littleEndian', 0.001, 2]],
        [4, ['batteryData', 'power'], ['Uint32', 'littleEndian', 0.001, 0]],
        [4, ['batteryData', 'current'], ['Int32', 'littleEndian', 0.001, 2]],
        // [8, ['batteryData', 'unknownSegments'], 'raw', null],
        [2, ['batteryData', 'temperatureProbes'], ['Int16', 'littleEndian', 0.1, 1]],
        [2, ['batteryData', 'temperatureProbes'], ['Int16', 'littleEndian', 0.1, 1]],
        [2, ['batteryData', 'mosTemperature'], ['Int16', 'littleEndian', 0.1, 1]],
        [4, ['batteryData', 'unknownSegments'], 'raw', null],
        [1, ['batteryData', 'unknownSegments'], 'raw', null],
        [1, ['batteryData', 'percentage'], ['Int8']],
        [4, ['batteryData', 'remainingCapacity'], ['Uint32', 'littleEndian', 0.001, 1]],
        [4, ['batteryData', 'nominalCapacity'], ['Uint32', 'littleEndian', 0.001, 1]],
        [4, ['batteryData', 'cycleCount'], ['Uint32', 'littleEndian', 1, 1]],
        // [2, ['batteryData', 'unknownSegments'], 'raw', null],
        // [2, ['batteryData', 'unknownSegments'], 'raw', null],
        [4, ['batteryData', 'cycledCapacity'], ['Uint32', 'littleEndian', 0.001, 0]],
        [2, ['batteryData', 'unknownSegments'], 'raw', null],
        [2, ['batteryData', 'unknownSegments'], 'raw', null],
